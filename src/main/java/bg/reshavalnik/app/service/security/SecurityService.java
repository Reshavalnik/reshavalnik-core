...
import bg.reshavalnik.app.service.role.RoleService;
...
public class SecurityService {
    ...
    public JwtResponse getAuthenticatUser(@Valid LoginRequest loginRequest) {
        if (loginRequest.getUsername().contains("admin")) {
            throw new IllegalArgumentException(
                    CANNOT_ENTER_AS_ADMIN + loginRequest.getUsername()
            );
        }
    ...
    public JwtResponse getRegisterUser(@Valid SignupRequest signUpRequest) {
        ...
        roleService.assignRoleToUser(user, ERole.ROLE_USER);
